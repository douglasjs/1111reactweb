    ...
    render(){
        ...
        return(
            <div className="card shadow mb-4">
                                        ...
                                        <div className="col-sm-12 col-md-6">
                                            <div className="dataTables_length" id="dataTable_length">
                                                ...
                                                <div id="dataTable_filter" className="dataTables_filter text-left">
                                                    {/*<a data-toggle="modal" href="#tmp6_addlable"><button className='btn btn-primary'>增加標籤 <i className="fas fa-folder-plus" value='Create' /></button></a>&nbsp;&nbsp;&nbsp;*/}
                                                    <a data-toggle="modal" href="#tmp6_addjob"><button className='btn btn-primary' onClick={this.handleAddPosition}>增加職缺 <i className="fas fa-folder-plus" value='Create' /></button></a>
                                                    (<a type="button" data-toggle="modal" href="#tmp6_joblable_img">觀看圖例</a>)
                                                </div>
                                            </div>
                                        </div>
                                </div>
                                    ...
                                    <table className="table table-hover table-bordered" id="dataTable">
                                        <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th onClick={()=>(this.handleShort('position_dutyName'))}>職位類型   {this.sortMark('position_dutyName')}  </th>
                                            ...
                                            {Array.isArray(positionData) && positionData.sort(this.sortFunc).map((element, index) => {
                                                    return(
                                                        <tr key={index}>
                                                            ...
                                                            <td className='text-left'>{element.position_dutyName} </td>
                ...
                <div className="modal fade" id="tmp6_addlable">
                            ...
                            <div className="modal-body text-center">
                                ...
                                <form id='dataTagForm' className={positionGrpIsLoading ? 'd-none' : ''}  onSubmit={this.handleTagSubmit}>
                                    ...
                                    <div align="center">
                                        ...
                                        <button type='button' id='addPosition' data-toggle="modal" data-target="#tmp6_addjob" className={`btn btn-google btn-width ${groupEmpty}`}><i className="fas fa-newspaper"></i> 新增職缺</button>
                                    </div>
                                </form>
                ...
                <div className="modal fade" id="tmp6_joblable_img">
                    <div className="modal-dialog sample-img-width">
                        <div className="modal-content">
                            ...
                            <div className="modal-body text-center">
                                <img src="/image/sample_06/04.png" alt="tmp6_joblable_img" width="100%" />
                            </div>
                            <div className="modal-footer">
                ...
                <div className="modal fade" id="tmp6_addjob">
                    <div className="modal-dialog sample-img-width">
                        <div className="modal-content">
                            <div className="modal-header">
                                        ...
                                        <table className="table table-hover table-bordered" id="dataTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th onClick={()=>(this.handleShort('DutyArr'))}>職位類型   {this.sortMark('DutyArr')}  </th>
                                                ...
                                                { kind00Data && dataID!==0 && kind00Data.filter(this.handleSearch/*data=> data.WorkCity === this.state.cityGroup ||  data.DutyArr[0] === this.state.dutyGroup*/).map( (element, index) =>{
                                                    ...
                                                    return(
                                                        <tr key={index}>
                                                            ...
                                                            <td className='text-left'>{element.DutyArr[0].DutyName}</td>
