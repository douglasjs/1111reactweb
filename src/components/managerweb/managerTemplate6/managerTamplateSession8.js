                    ...
                    <div className="card-body">
                        ...
                        <form id='dataForm8' className={contactIsLoading ? 'd-none' : ''}  onSubmit={this.handleSubmit}>
                            ...
                            <div className="form-row">
                                ...
                                <div className="col-md-6 mb-3">
                                    <div><img src="/image/sample_06/08.png" alt="Temp6_Contact" width="100%"/></div>
                                    <div><a type="button" data-toggle="modal" href="#tmp6_contact">觀看放大圖例</a></div>
                                    <hr />
                                    <div>
                        ...
                        <div className="modal fade" id="tmp6_contact">
                            <div className="modal-dialog sample-img-width">
                                <div className="modal-content">
                                    ...
                                    <div className="modal-body text-center">
                                        <img src="/image/sample_06/08.png" alt="tmp6_contact" width="100%" />
                                    </div>
