                    ...
                    <div className="row">
                        ...
                        <div className="lqd-column col-md-8 col-md-offset-2">
                            ...
                            <header className="fancy-title fancy-title-1111 text-center">
                                ...
                                <h2 className="mt-3 mb-3">{introTitle}</h2>
                                <h6 className="font-size-16 opacity-05">{introMainContent}</h6>
