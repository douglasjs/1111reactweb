...
function CustomerMain(props){
            ...
            let styleSheet = [
                ...
                '/assets/tp05/vendors/liquid-icon/liquid-icon.min.css',
                '/assets/tp05/vendors/font-awesome/css/font-awesome.min.css',
                '/assets/tp05/css/theme-vendors.min.css',
                '/assets/tp05/css/theme.min.css',
                '/assets/tp05/css/creative.css'
            ]
            let email;
            let themeNum;
            ...
            if(data && data.length > 0){
                ...
                styleSheet[4] = `/assets/tp05/css/${data[0].styleType}`;
