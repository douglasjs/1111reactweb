				...
				<div className="row d-flex flex-wrap align-items-center">
									...
									<div className="liquid-img-group-single" data-roundness="4">
										<div className="liquid-img-group-img-container">
											<div className="liquid-img-container-inner" data-parallax="true" data-parallax-from='{"translateY":47}' data-parallax-to='{"translateY":-74}' data-parallax-options='{"overflowHidden": false, "easing": "linear"}'>
												<figure>
													<img src="./image/tp05/company-1.jpg"  alt="1111人力銀行公司介紹" />
												</figure>
											</div>
										</div>
									</div>
									...
									<div className="liquid-img-group-single" data-roundness="4">
										<div className="liquid-img-group-img-container">
											<div className="liquid-img-container-inner" data-parallax="true" data-parallax-from='{"translateY":83}' data-parallax-to='{"translateY":-94}' data-parallax-options='{"overflowHidden": false, "easing": "linear"}'>
												<figure>
													<img src="./image/tp05/company-2.jpg" alt="1111人力銀行公司介紹" />
												</figure>
											</div>
										</div>
									</div>
									...
									<div className="liquid-img-group-single" data-roundness="4">
										<div className="liquid-img-group-img-container">
											<div className="liquid-img-container-inner" data-parallax="true" data-parallax-from='{"translateY":167}' data-parallax-to='{"translateY":-151}' data-parallax-options='{"overflowHidden": false, "easing": "linear"}'>
												<figure>
													<img src="./image/tp05/company-3.jpg"  alt="1111人力銀行公司介紹" />
												</figure>
											</div>
										</div>
									</div>
					...
					<div className="lqd-column col-md-5 col-lg-5 "  data-custom-animations="true" data-ca-options='{"triggerHandler":"inview","animationTarget":"all-childs","duration":1200,"delay":160,"initValues":{"translateY":50,"opacity":0},"animations":{"translateY":0,"opacity":1}}'>
						...
						<header className="fancy-title mb-60">
							...
							<h2 className="mt-1 mb-2">加入亞尼克</h2>
							<p> 20年來，<br />
                                亞尼克不斷在企業經營及產品品質上，以高標準自我要求，<br />
                                每個環節的層層把關，<br />
                                從原物料嚴選、製程控管，並且不停持續研發創新。<br />
                                <br />
                                讓我們從萬里小鎮，一間小小七坪蛋糕工作坊發跡，<br />
                                一路走來到現在，<br />
                                更擁有北中南全台擁有多家門市，並且持續擴大經營中，<br />
                                為的是將最好的甜點分享給更多的消費者。
                            </p>
						</header>

						<a target='_blank' rel='noopener noreferrer' href="https://www.1111.com.tw/corp/51395296/?agent=sticktop_51395296#c4" className="btn btn-solid text-uppercase circle btn-bordered border-thin font-size-18 font-weight-semibold" >
							<span>
