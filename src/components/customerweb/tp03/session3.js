                ...
                <div className="row align-items-center">
                        ...
                        <div className="service-inner-wrap service-business-classic">
                            <div className="row">
                                <div className="col-sm-6">
                                    <div className="icon-box-item text-left">
                                        <div className="icon-box__icon">
                                            <img src="/image/tp03/benefit1.png" alt="福利" />
                                        </div>
                                ...
                                <div className="col-sm-6">
                                    <div className="icon-box-item text-left">
                                        <div className="icon-box__icon">
                                            <img src="/image/tp03/benefit2.png" alt="福利" />
                                        </div>
                                        <div className="icon-box__txt">
                                            <h6>節慶福利</h6>
                                            <p>年節禮券、生日禮券、春酒聚餐</p>
                                ...
                                <div className="col-sm-6">
                                    <div className="icon-box-item text-left">
                                        <div className="icon-box__icon">
                                           <img src="/image/tp03/benefit3.png" alt="福利" />
                                        </div>
                                        <div className="icon-box__txt">
                                            <h6>獎金類</h6>
                                ...
                                <div className="col-sm-6">
                                    <div className="icon-box-item text-left">
                                        <div className="icon-box__icon">
                                            <img src="/image/tp03/benefit4.png" alt="福利" />
                                        </div>
                                        <div className="icon-box__txt">
                                            <h6>其他福利</h6>
                                            <p>餐 飲 類：免費供餐<br />
                    ...
                    <div className="col-lg-5 order-0 order-lg-1">
                        <figure className="about-thumb about-thumb-right-align">
                            <img src="/image/tp03/benifit-1.jpg" alt="1111人力銀行員工福利" />
                        </figure>
                    </div>
                </div>
            </div>
