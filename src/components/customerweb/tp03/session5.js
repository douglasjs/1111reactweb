        ...
        <div id="brand" className="gallery-banner-area custom-top">
            <div className="row no-gutters">
                <div className="col-md-6 col-xl-6">
                    <div className="gallery-banner-item bg-img" data-bg="image/tp03/brand-1.jpg"></div>
                </div>
                <div className="col-md-6 col-xl-3">
                    <div className="gallery-banner-item bg-img" data-bg="image/tp03/brand-2.jpg"></div>
                </div>
                <div className="col-md-6 col-xl-3">
                ...
                <div className="col-md-6 col-xl-3">
                    <div className="gallery-banner-item bg-img" data-bg="image/tp03/brand-3.jpg"></div>
                </div>
                <div className="col-md-6 col-xl-3">
                ...
                <div className="col-md-6 col-xl-6">
                    <div className="gallery-banner-item bg-img" data-bg="image/tp03/brand-4.jpg"></div>
                </div>
            </div>
        </div>
    )
