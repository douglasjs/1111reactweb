                ...
                <div className="row">
                    <div className="col-lg-9 m-auto">
                        <div className="testimonial-content-landing">
                            ...
                            <div className="testimonial-item testimonial-item--2">
                                <figure className="client-thumb">
                                    <img src="image/tp03/jobs/jobs_logo_02.png" alt="1111人力銀行職缺介紹" />
                                </figure>
                            ...
                            <div className="testimonial-item testimonial-item--2">
                                <figure className="client-thumb">
                                    <img src="image/tp03/jobs/jobs_logo_03.png" alt="1111人力銀行職缺介紹" />
                                </figure>
                            ...
                            <div className="testimonial-item testimonial-item--2">
                                <figure className="client-thumb">
                                    <img src="image/tp03/jobs/jobs_logo_04.png" alt="1111人力銀行職缺介紹" />
                                </figure>
