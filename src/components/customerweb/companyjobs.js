                        ...
                        <div className="tabs tabs-nav-centered tabs-nav-items-bordered jobs-nav-active-filled">
                            <ul className="nav tabs-nav ltr-sp-175 font-weight-bold" role="tablist">
                                <li role="presentation" className="active">
                                    <a style={style} href="#ld-tab-pane-17" aria-expanded="false" aria-controls="ld-tab-pane-17" role="tab" data-toggle="tab"> 北部 </a>
                                </li>
                                <li role="presentation">
                                    <a style={style} href="#ld-tab-pane-18" aria-expanded="false" aria-controls="ld-tab-pane-18" role="tab" data-toggle="tab"> 中部 </a>
                                </li>
                                <li role="presentation">
                                    <a style={style} href="#ld-tab-pane-19" aria-expanded="false" aria-controls="ld-tab-pane-19" role="tab" data-toggle="tab"> 南部 </a>
                                </li>
                            </ul>
                                ...
                                <div id="ld-tab-pane-17" role="tabpanel" className="tabs-pane fade active in">
                                    ...
                                    <div className="jobs-table">
                                        ...
                                        <div className="jobs-table-row">
                                            <div className="cell" data-title="職缺：">業務專員(電商&amp;禮贈品)</div>
                                        ...
                                        <div className="jobs-table-row">
                                            <div className="cell" data-title="職缺：">中/西餐廚師(私廚)</div>
                                            <div className="cell" data-title="薪資：">面議(經常性薪資4萬/月含以上)</div>
                                            <div className="cell" data-title="福利：">
                                                <p className="jobs-hide-text">
                                                    其 　他：一、多樣全面的福利項目：
                                        ...
                                        <div className="jobs-table-row">
                                            <div className="cell" data-title="職缺：">電話銷售主任/副理(客服部)</div>
                                            <div className="cell" data-title="薪資：">面議(經常性薪資4萬/月含以上)</div>
                                            <div className="cell" data-title="福利：">
                                                <p className="jobs-hide-text">
                                                    其 　他：一、多樣全面的福利項目：
                                        ...
                                        <div className="jobs-table-row">
                                            <div className="cell" data-title="職缺：">外場副理 (山海樓手工台菜餐廳)</div>
                                            <div className="cell" data-title="薪資：">面議(經常性薪資4萬/月含以上)</div>
                                            <div className="cell" data-title="福利：">
                                                <p className="jobs-hide-text">
                                                    其 　他：一、多樣全面的福利項目：
                                        ...
                                        <div className="jobs-table-row">
                                            <div className="cell" data-title="職缺：">清潔人員</div>
                                            <div className="cell" data-title="薪資：">面議(經常性薪資4萬/月含以上)</div>
                                            <div className="cell" data-title="福利：">
                                                <p className="jobs-hide-text">
                                                    其 　他：一、多樣全面的福利項目：
