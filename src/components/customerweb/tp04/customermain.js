...
function CustomerMain(props){
            ...
            let styleSheet = [
                '/assets/tp04/css/bootstrap.min.css',
                '/assets/tp04/css/animate.min.css',
                '/assets/tp04/css/fontawesome.min.css',
                '/assets/tp04/css/flaticon.css',
                '/assets/tp04/css/owl.carousel.min.css',
                '/assets/tp04/css/slick.min.css',
                '/assets/tp04/css/meanmenu.css',
                '/assets/tp04/css/magnific-popup.min.css',
                '/assets/tp04/css/odometer.min.css',
                '/assets/tp04/css/nice-select.min.css',
                '/assets/tp04/css/responsive.css',
                '/assets/tp04/css/topbutton.css'
            ]
            let email;
            let themeNum;
